...
router.put("/actualizar/:id", async (req, res) => {
    const { id } = req.params;
    const { tipoPago, cambio, subtotal, total, pagado, iva, comision, productos, estado, metodosDePago } = req.body;
    await ventas
        .updateOne({ _id: id }, { $set: { tipoPago, cambio, subtotal, total, pagado, iva, comision, productos, estado, metodosDePago } })
